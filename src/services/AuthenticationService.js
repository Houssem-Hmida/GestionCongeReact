...
class AuthenticationService {
  ...
  rezetpassword = (email,password,confirmepassword) => {
    return axios.post("http://localhost:8091/rezetPassword", {email,password,confirmepassword})
    .then(response => { 
        return response.data;
    })
  }

  compare = (email,password,confirmepassword) => {
    return axios.post("http://localhost:8091/compare", {email,password,confirmepassword})
    .then(response => { 
        return response.data;
    })
  }
